...
class Component:
    ...
    def lock_rotate(self):
        self.setRotateExtent(self.uAxis, self.default_uAngle)
        self.setRotateExtent(self.vAxis, self.default_vAngle)
        self.setRotateExtent(self.wAxis, self.default_wAngle)
